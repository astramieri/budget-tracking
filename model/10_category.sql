...
insert into category (type, color, name, icon) values ('E', 'u-color-1', 'Car maintenance', 'fa-car');
insert into category (type, color, name, icon) values ('E', 'u-color-7', 'Car payment',     'fa-car');
